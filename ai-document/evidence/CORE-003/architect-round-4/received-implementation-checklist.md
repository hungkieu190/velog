...
- Exact next action: Review fix evidence for CORE-003 F-002–F-006 under correction revision 5 and WF-003 WF3-F-002/WF3-F-003 under revision 3; preserve closed F-001/WF3-F-001 and return raw evidence.
- Planning queue: CORE-001 and CORE-002 are DONE. CORE-003 and WF-003 are READY_FOR_REVIEW after builder fixes. G-02 is approved; G-03–G-08 remain pending.
...
Tooling bootstrap and master-plan revision 3 are accepted. CORE-001 and CORE-002 are DONE; CORE-003 and WF-003 are READY_FOR_REVIEW after builder fixes; PHP lint and Node workflow gates pass, but two required lifecycle tests skip and real integration/cleanup evidence is insufficient. Checklist counts represent recorded work only, not overall product completion.
...
- [ ] CORE-003 / AC1: Explicit manager/admin/technician policy is enforced at object and primitive levels. Status: READY_FOR_REVIEW.
- [ ] CORE-003 / AC2: Anonymous, subscriber and unrelated editor cannot discover private records through public/native endpoints. Status: READY_FOR_REVIEW.
- [ ] CORE-003 / AC3: Activation/reactivation and role collisions preserve unrelated roles/capabilities. Status: READY_FOR_REVIEW.
- [ ] CORE-003 / AC4: Real WordPress permission/lifecycle evidence and runner failure/cleanup controls pass. Status: READY_FOR_REVIEW.
...
- [ ] WF-003 / AC1: Canonical/decorated roles agree; genuine conflicts remain visible. Status: CHANGES_REQUESTED.
- [ ] WF-003 / AC2: Latest bare/text handoff is parsed without stale fallback or substring-based false validation. Status: CHANGES_REQUESTED.
- [ ] WF-003 / AC3: Read-only escaped dashboard and focus/checklist diagnostics pass regression and HTTP checks. Status: CHANGES_REQUESTED.

Task: [WF-003](tasks/WF-003-progress-owner-consistency.md). User approved on 2026-09-23. Independent review requests remaining WF3-F-002/WF3-F-003 corrections under revision 3; current focus remains CORE-003. No implementation acceptance claimed.
