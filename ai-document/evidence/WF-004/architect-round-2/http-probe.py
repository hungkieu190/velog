...
root=Path.cwd();out=root/'ai-document/evidence/WF-004/architect-round-2';tmp=Path(tempfile.mkdtemp(prefix='wf004-http-'))
p=None
try:
 ...
 (tmp/'ai-document/agent-roles.json').write_text(json.dumps({'schema_version':1,'assignments':{'codex':{'role':'architect'},'antigravity':{'role':'builder'}}}))
