...
## Documentation maintenance — 2026-09-18 (Architect)

The user explicitly requested consolidation and optimization of AGENT.md and AGENTS.md. AGENTS.md is now the single agent manual; AGENT.md was removed and active contributor/pre-flight references were updated. Historical scope, reports, prompts and acceptance hashes above and in evidence/ remain unchanged as records of the accepted WF-001 snapshot; historical AGENT.md reading instructions now resolve to AGENTS.md. This documentation maintenance does not reopen WF-001, change PLAN-001 approval, or constitute new product acceptance.
